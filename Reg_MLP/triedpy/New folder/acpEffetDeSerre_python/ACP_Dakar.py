# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 03:31:14 2018
...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 16 03:23:09 2018
...
if __name__ == "__main__":
   ...
   if 'mois' in locals() or 'annee' in locals():
       fig = plt.figure(figsize=(18, 6))
       plt.suptitle("Affichage en fonction de la qualité Ville=Dakar"); 
   ...
   if 'mois' in locals() or 'annee' in locals():
       fig = plt.figure(figsize=(18, 6))
       plt.suptitle("Affichage en fonction de la contribution Ville=Dakar"); 
   if 'mois' in locals() and 'annee' in locals():
       plt.subplot(2,1,1)
